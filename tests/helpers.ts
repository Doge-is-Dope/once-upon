...
export const ordinaryRecordProse =
  'The subject follows the choice across the quiet room. The handleless door stays shut, the torn notebook remains on the table, and a measured current of air passes behind the wardrobe. Nothing answers for the subject; the speaker waits while the subject decides what to examine next.';
